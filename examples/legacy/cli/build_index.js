 ...
 *
 * Usage:
 *   node examples/legacy/cli/build_index.js --embeddings embeddings.bin --output index.pnck
 */
...
async function main() {
    ...
    if (!embeddingsPath) {
        console.log('Usage: node examples/legacy/cli/build_index.js --embeddings <file> [options]');
        console.log('');
        console.log('Options:');
