...
async function testDCTCompression() {
...
async function testMetricCorrectnessDCT() {
    section('Deprecated import compatibility');
    ...
    const view = new DataView(deprecated.buffer);
    view.setUint32(4, 1, true);
    view.setUint32(12, DIM / 2, true);

    let msg = '';
    try { idx.import(deprecated); } catch (e) { msg = e.message; }
    assert(msg.includes('no longer supported'), 'deprecated DCT/PCA imports stay rejected');
